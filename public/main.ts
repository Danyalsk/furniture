const parentMarquee = document.querySelector(
  ".marquee-wrapper"
) as HTMLDivElement;
const childMarquee = document.querySelector(
  ".marquee-content"
) as HTMLDivElement;

// will clone the child node of Parent Marquee or copy the sibling
const adChildMarquee = (
  document.querySelector(".marquee-content") as HTMLDivElement
).cloneNode(true);
parentMarquee.appendChild(adChildMarquee);

// code below will allow a draggable feature for the marquee carousel
const ulParentListContainer = document.querySelector(
  ".marquee-wrapper"
) as HTMLDivElement;
